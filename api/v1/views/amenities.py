#!/usr/bin/python3
"""View that handles all amenities objects"""
...
def all_amenities():
    ...
    amenitiess = []
    for tmp in amenities.values():
        amenitiess.append(tmp.to_dict())
...
def put_amenity(amenity_id):
    """Update the amenity object eith the provided id"""
